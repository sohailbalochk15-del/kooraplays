...
import { fetchGames, fetchTeams, transformGames, resolveKnockoutBracket, type MatchData } from "../api/worldcup";
...
export function useMatches() {
  ...
  const data: MatchData[] | undefined =
    teamsQuery.data && gamesQuery.data
      ? resolveKnockoutBracket(transformGames(gamesQuery.data.games, teamsQuery.data.teams))
      : undefined;
